        ...
        <table class="table" cellpadding="5" style="width: 90%; color: black; margin: 0 auto;">
          <tbody style="text-align: center;">
            ...
            <tr>
              <th>비밀번호</th>
              <td>
                <input class="input input-info input-sm w-full" name="loginPw" autocomplete="off" type="password" placeholder="비밀번호 입력" />
              </td>
            </tr>
            <tr>
              <th></th>
              <td>
                <button type="submit" class="btn-back btn btn-ghost btn-xs">확인</button>
              </td>
            </tr>
          </tbody>
        </table>
