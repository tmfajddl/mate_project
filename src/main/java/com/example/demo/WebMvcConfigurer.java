...
//				.addPathPatterns("/usr/member/doJoin");
		...
		ir.addPathPatterns("/usr/comment/write");
		...
		ir.addPathPatterns("/usr/reactionPoint/doCommentGoodReaction");
		ir.addPathPatterns("/usr/reactionPoint/doCommentBadReaction");
